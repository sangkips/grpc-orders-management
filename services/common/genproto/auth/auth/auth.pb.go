...
const file_auth_auth_proto_rawDesc = "" +
	...
	"\x05roles\x18\x03 \x03(\tR\x05roles2\xcb\x01\n" +
	"\vAuthService\x120\n" +
	...
	"\aRefresh\x12\x19.auth.RefreshTokenRequest\x1a\x1a.auth.RefreshTokenResponseB!Z\x1fgithub.com/sangkips/common/authb\x06proto3"
...
var file_auth_auth_proto_depIdxs = []int32{
	6, // 0: auth.LoginResponse.user:type_name -> auth.UserInfo
	6, // 1: auth.ValidateTokenResponse.user:type_name -> auth.UserInfo
	...
	4, // 4: auth.AuthService.Refresh:input_type -> auth.RefreshTokenRequest
	...
	5, // 7: auth.AuthService.Refresh:output_type -> auth.RefreshTokenResponse
